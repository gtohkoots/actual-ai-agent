...
- [mcp_client.py](/Users/ketia/Documents/Actual/My-Finances-b5b9544/finance-agent/backend/agents/mcp_client.py:1)
  - provides a tiny adapter for reading planner resources through the FastMCP runtime
...
5. Build a planner prompt context from those MCP resources.
6. Ask the LLM to produce:
   - a summary
   - highlights
   - a next action
7. Return the response together with the MCP context it used.
